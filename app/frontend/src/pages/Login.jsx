...
import { GraduationCap, Lock, Mail, LogOut, User, ArrowLeft } from "lucide-react";
        ...
        <div className="crce-card p-8" style={{ background: "rgba(255,255,255,0.82)" }}>
          ...
          <form onSubmit={onSubmit} className="space-y-4" autoComplete="off">
            ...
            <div className="flex justify-end -mt-1 mb-1">
              <Link to="/forgot-password" className="text-xs hover:underline" style={{ color: "var(--crce-primary)" }}>
                Forgot password?
              </Link>
            </div>
